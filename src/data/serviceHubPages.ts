...
export const exteriorRooflineHub: ServiceHubDefinition = {
  ...
  metaDescription: `Roof cleaning, gutter clearing and PVC fascias across ${META_AREA_PHRASE}. Free quotes from EdiClean — moss, leaks and dull white PVC solved safely.`,
  heroTitle: "Roofline exterior cleaning",
  heroSubtitle: "Roofs, rainwater goods & white PVC across Edinburgh and the Lothians",
  intro: [
    `When moss sits on slates and tiles, or gutters choke with leaves, water gets pushed somewhere it shouldn't — into loft spaces, down walls and over paths. Our roofline-focused work tackles that stack together: safe roof cleaning to lift moss and algae, gutter clearing so rainwater runs again, and PVC white cleaning so fascias and soffits match the effort you've put into the roof.`,
