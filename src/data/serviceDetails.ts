...
export const serviceDetails: Record<string, ServiceDetailContent> = {
  ...
  "render-softwashing": {
    ...
    whyChoose: {
      title: "Why Choose EdiClean's Render & Roughcast Cleaning?",
      points: [
  ...
  "moss-removal": {
    heroDescription:
      "Specialist moss and algae removal for roofs, patios and driveways across Edinburgh and the Lothians. We clear moss safely from slate, tile and concrete without damaging the surface, and can apply a treatment to slow regrowth.",
    whyChoose: {
      title: "Why Choose EdiClean's Moss & Algae Removal?",
      points: [
        {
    ...
    faqs: [
      ...
      { question: "Do you offer moss removal near me?", answer: "Yes, we cover Edinburgh, Midlothian, East Lothian and West Lothian. Get in touch for a free quote." },
    ],
  },
  "patio-cleaning": {
    heroDescription:
      "Patio cleaning and pressure washing for slabs, monoblock and decking. We lift algae, moss and grime from patios across Edinburgh and the Lothians, leaving outdoor spaces safe and ready to use.",
    whyChoose: {
      title: "Why Choose EdiClean's Patio Cleaning?",
      points: [
        {
    ...
    faqs: [
      ...
      { question: "Do you offer patio cleaning near me?", answer: "Yes, we cover Edinburgh, Midlothian, East Lothian and West Lothian. Get in touch for a free quote." },
    ],
  },
};
