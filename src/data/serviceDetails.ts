...
import { BUSINESS_NAME, META_AREA_PHRASE, PHONE_DISPLAY, SERVICE_REGION_SHORT } from "@/constants/site";
...
export const serviceDetails: Record<string, ServiceDetailContent> = {
  ...
  "render-softwashing": {
    ...
    whyChoose: {
      ...
      points: [
        { title: "21 Years Experience", description: "" },
        { title: "5 Star Rated", description: "" },
        { title: `${SERVICE_REGION_SHORT} Coverage`, description: "" },
    ...
    faqs: [
      { question: "How can I book or get a quote?", answer: `Call or message us on ${PHONE_DISPLAY}, or fill out the contact form on our website, and we'll get back to you with a free, no-obligation quote.` },
      { question: "Do you offer ongoing maintenance?", answer: "Yes. Alongside a one-off render softwash, we offer a maintenance plan to help keep your property looking its best year-round." },
      ...
      { question: "Do you cover the whole of the local area?", answer: `Yes. We're based in Edinburgh and cover ${META_AREA_PHRASE}.` },
