        ...
        <div className="box-border caret-transparent items-center gap-x-10 flex flex-col gap-y-10 md:flex-row-reverse">
          <div className="box-border caret-transparent w-full md:w-[500px] md:shrink-0">
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              {/*
                TODO: Replace with real distinct before/after render-softwashing photos once
                available — Ediclean's portfolio currently has no separate before/after image
                pair for render cleaning, so both slots point at the same real in-progress
                render-softwash photo rather than a fabricated pair.
              */}
              <div className="relative overflow-hidden rounded-2xl aspect-[3/4]">
                <img
                  src="/portfolio/render-softwash.jpg"
